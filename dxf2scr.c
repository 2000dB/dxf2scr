...
Revision 20-Mar-03
Modified by Vincent de Beleval 2013/11/18, fixed errors and added scale as an argument
...
int main(int argument_count, char *argument[], char *environment[])
{
  ...
  xorg=atof(argument[3])*scale;
  yorg=atof(argument[4])*scale;
  scale=atof(argument[5]);
